...
\hspace*{0cm}Curso de Engenharia de Computação Cooperativo  \\
\end{center}}
% se você souber meter o logo da POLI aqui, ficaria legal...
\vspace{4.0cm}
\noindent
\begin{center}
{\Large \bf Discretização do modelo do Pêndulo} \\[3cm]
{\Large Bruno Andreetto, bruno.andreetto@usp.br}\\[6mm]
{\Large Daniel Triggo Rizutto, daniel.triggo.rizutto@usp.br}\\[6mm]
